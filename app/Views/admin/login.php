        ...
        <div class="card shadow-lg p-4 mt-3" style="max-width: 400px; width: 100%;">
            <div class="border-bottom">
                <div class="text-center mb-4">
                    <img src="<?= base_url('templates/img/icon.png') ?>" alt="Logo" class="img-fluid" style="max-width: 200px;" />
                </div>
            ...
            <form action="javascript:void(0)" method="post" id="login_form">
                <div class="mb-3 mt-3">
                    ...
                    <div class="input-group input-group-md">
                        <input type="email" name="email" class="form-control" id="login_email" placeholder="Enter email" required />
                ...
                <div class="mb-3">
                    ...
                    <div class="input-group input-group-md">
                        <input type="password" name="password" class="form-control" id="login_password" placeholder="********" required />
