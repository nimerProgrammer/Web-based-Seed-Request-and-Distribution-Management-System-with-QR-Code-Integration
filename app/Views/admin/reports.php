    ...
    <section class="content">
        <div class="container-fluid">
            <div class="row">
                <!-- <div class="col-lg-12">
                    <div class="dropdown">
                        <button class="btn btn-sm btn-outline-primary dropdown-toggle float-end" type="button"
                ...
                <div class="col-lg-12">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12">
                                            <div class="btn-group mb-3" role="group" aria-label="Export Buttons">
                                                ...
                                                <!-- Cropping Season Dropdown Form -->
                                                <form id="seasonForm"
                                                    action="<?= base_url( '/admin/reports/setSeasonView' ) ?>" method="post"
                                                    style="display: none;">
                                                    <?= csrf_field() ?>
                                                    <input type="hidden" name="season_data" id="seasonDataInput">
                                                </form>
                    ...
                    <?php else : ?>
                        <div class="mt-3 p-3 rounded border-secondary text-center"
                            style=" border: 2px dashed var(--bs-secondary);">
                            <h5>
                                Choose a list to view reports.
                                <br>
                                <small class="text-muted">Please select a list from the dropdown
                                    above.</small>
                            </h5>
                        </div>
