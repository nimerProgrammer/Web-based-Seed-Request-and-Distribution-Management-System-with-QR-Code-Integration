...
<div class="content-wrapper">
    ...
    <section class="content">
        <div class="container-fluid">
                ...
                <tbody>
                    <tr>
                        <td class="align-middle">
                            ...
                            <br>
                            <small style="white-space: nowrap;" class="text-muted">
                                <i class="fa-solid fa-house text-secondary"></i>&nbsp;Barangay
                            </small>
                        </td>
                        <td>
                            <i id="editBarangayBtn" class="bi bi-pencil-square text-primary float-end"
                                style="white-space: nowrap;" data-bs-toggle="tooltip" title="Edit"
                                data-barangay="<?= esc( $users[ 'brgy' ] ) ?>" data-bs-toggle="modal"
                                data-bs-target="#editBarangayModal">&nbsp;edit
                            </i>
                        </td>
                    </tr>
                    <tr>
                        <td colspan="2" class="align-middle">
                            ...
                            <br>
                            <small style="white-space: nowrap;" class="text-muted">
                                <i class="fa-solid fa-landmark text-secondary"></i>&nbsp;Municipality
                            </small>
                        </td>
                    </tr>
                    <tr>
                        <td colspan="2" class="align-middle">
                            ...
                            <br>
                            <small style="white-space: nowrap;" class="text-muted">
                                <i class="fa-solid fa-location-dot text-secondary"></i>&nbsp;Province
                            </small>
                        </td>
                    </tr>
                </tbody>
            ...
            <div class="border-bottom">
                <h6 class="text-bold">Farm Information</h6>
            </div>
            <table class="table table-transparent  table-hover">
                <tbody>
                    <tr>
                        <td class="align-middle">
                            ...
                            <br>
                            <small style="white-space: nowrap;" class="text-muted">
                                <i class="fa-solid fa-map text-secondary"></i>&nbsp;Farm
                                Area (hectares)
                            </small>
                        </td>
                        <td>
                            <i id="editFarmAreaBtn" class="bi bi-pencil-square text-primary float-end"
                                style="white-space: nowrap;" data-bs-toggle="tooltip" title="Edit"
                                data-farmarea="<?= esc( $users[ 'farm_area' ] ) ?>" data-bs-toggle="modal"
                                data-bs-target="#editFarmAreaModal">&nbsp;edit
                            </i>
                        </td>
                    </tr>
                    <tr>
                        <td class="align-middle">
                            <?= esc( $users[ 'name_land_owner' ] ) ?>
                            <br>
                            <small style="white-space: nowrap;" class="text-muted">
                                <i class="fa-solid fa-user text-secondary"></i>&nbsp;Name
                                of land owner
                            </small>

                        </td>
                        <td>
                            <i id="editNameLandOwnerBtn" class="bi bi-pencil-square text-primary float-end"
                                style="white-space: nowrap;" data-bs-toggle="tooltip" title="Edit"
                                data-namelandowner="<?= esc( $users[ 'name_land_owner' ] ) ?>" data-bs-toggle="modal"
                                data-bs-target="#editNameLandOwnerModal">&nbsp;edit
                            </i>
                        </td>
                    </tr>
                    <tr>
                        <td class="align-middle">
                            <?= esc( $users[ 'rsbsa_ref_no' ] ) ?>
                            <br>
                            <small style="white-space: nowrap;" class="text-muted">
                                <i class="fa-solid fa-id-card text-secondary"></i>&nbsp;RSBSA No.
                            </small>

                        </td>
                        <td>
                            <i id="editRSBSABtn" class="bi bi-pencil-square text-primary float-end"
                                style="white-space: nowrap;" data-bs-toggle="tooltip" title="Edit"
                                data-rsbsa="<?= esc( $users[ 'rsbsa_ref_no' ] ) ?>" data-bs-toggle="modal"
                                data-bs-target="#editBarangayModal">&nbsp;edit
                            </i>
                        </td>
                    </tr>
